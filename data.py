disease_info = {
    ...
    "Salmonella": {
        ...
        "statistical": (
            "- Khoảng *94* triệu ca nhiễm và *155.000* ca tử vong mỗi năm trên toàn thế giới.\n"
            "- Mỗi ca nhiễm tốn khoảng 1.000 USD khi nhập viện.\n"
        ),
        # "symptoms": (
        #     "Kém ăn bỏ ăn, lông xù, sã cánh ỉa  chảy phân xanh, phân vàng, mào thâm."
        #     "Chảy nước mắt nước mũi."
        ...
        # ),
        "damage": (
            "- Tại Hoa Kỳ và châu Âu, nhiều trường hợp các công ty bị thiệt hại nặng nề lên đến hàng tỉ USD vì các mẫu thử Salmonella dương tính dẫn đến bị tẩy chay bởi các khách hàng.\n"
            "- Ở châu Âu, 49% chủng Salmonella phân lập ở người có khả năng kháng một hoặc nhiều nhóm kháng sinh. Trong tổng số các phân lập chủng Salmonella Typhimurium được báo cáo ở châu Âu trong năm 2018, hơn một phần ba (38,2%) mẫu kháng đa thuốc (MDR) – chỉ riêng biến thể ST đơn pha đã có 80,5%"
